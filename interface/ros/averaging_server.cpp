...
#include <${APP_INTERFACE_NAME}/AveragingAction.h>
...
protected:
    ros::NodeHandle nh_;
    actionlib::SimpleActionServer<${APP_INTERFACE_NAME}::AveragingAction> as_;
    std::string action_name_;
    int data_count_, goal_;
    float sum_, sum_sq_;
    ${APP_INTERFACE_NAME}::AveragingFeedback feedback_;
    ${APP_INTERFACE_NAME}::AveragingResult result_;
    ros::Subscriber sub_;
};
